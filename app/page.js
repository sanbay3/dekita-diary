...
const DiaryApp = dynamic(() => import("@/components/DiaryApp"), {
  ssr: false,
  loading: () => (
    <div className="w-full max-w-2xl rounded-3xl bg-stone-100 p-6 text-center text-sm text-stone-400 shadow-sm dark:bg-stone-900 dark:text-stone-500 sm:p-8">
      読み込み中...
    </div>
  ),
});
...
export default function Home() {
  return (
    <div className="flex flex-1 flex-col items-center bg-stone-50 px-4 py-10 dark:bg-black sm:py-16">
      <DiaryApp />
    </div>
  );
}
